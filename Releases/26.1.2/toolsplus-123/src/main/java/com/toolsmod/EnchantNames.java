...
public class EnchantNames {
    ...
    static {
        ...
        RU.put("скрытное_движение",       "minecraft:swift_sneak");
        ...
        RU.put("плотность",               "minecraft:density");
        RU.put("пробой",                  "minecraft:breach");
        RU.put("ветряной_заряд",          "minecraft:wind_burst");
        ...
        EN.put("swift_sneak",             "minecraft:swift_sneak");
        ...
        EN.put("density",                 "minecraft:density");
        EN.put("breach",                  "minecraft:breach");
        EN.put("wind_burst",              "minecraft:wind_burst");
    }
