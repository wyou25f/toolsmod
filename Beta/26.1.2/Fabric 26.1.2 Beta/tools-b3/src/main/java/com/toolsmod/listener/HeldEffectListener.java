...
public class HeldEffectListener {
    ...
    public static void register() {
        ServerTickEvents.END_SERVER_TICK.register(server -> {
            ...
            try {
                lookup = server.registryAccess().lookupOrThrow(Registries.MOB_EFFECT);
            } catch (Exception e) {
                return;
            }
            ...
            for (ServerPlayer player : server.getPlayerList().getPlayers()) {
                ...
                if (data != null) {
                    ...
                    if (!effectId.isEmpty() && effectId.contains(":")) {
                        ...
                        newEffect = lookup.get(ResourceKey.create(Registries.MOB_EFFECT, id))
                            .orElse(null);
                    }
                }
                ...
                if (newEffect != null) {
                    if (previous != null && !previous.equals(newEffect)) {
